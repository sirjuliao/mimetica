(function(){
  ...
  var elHero=document.getElementById('c-hero'), elFontes=document.getElementById('c-fontes'),
      ...
      elMon=document.getElementById('c-monitoramento'),
      elBlog=document.getElementById('c-blog-card');
  if (!elHero||!elFontes||!elPerfis||!elDif||!elComp||!elCen||!elMon) return;
  ...
  var fields = [hero, fontes, perfis, dif, comp, cen, mon];
